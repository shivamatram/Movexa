...
import com.example.movexa.databinding.FragmentMechanicProfileBinding
...
/**
 * Profile tab for the Mechanic dashboard.
 *
 * Provides sign-out functionality for mechanics.
 */
class MechanicProfileFragment : BaseFragment<FragmentMechanicProfileBinding>(
    FragmentMechanicProfileBinding::inflate
) {
